...
<template>
<div
  class="flex flex-col justify-start items-start w-[387px] h-[417px] mt-16 ml-10 relative rounded-lg bg-white border-[1.5px] border-indigo-100"
>
  <div class="self-stretch flex-grow-0 flex-shrink-0 h-[200px]">
    ...
    ></div>
    <img
      src="\Users\yanis\OneDrive\Bureau\tp-agence\src\components\pexels-binyamin-mellish-106399-1.jpg"
